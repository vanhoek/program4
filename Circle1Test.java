...
public class Circle1Test
{
   ...
   private Circle1 circle2, circle3, circle4; //added for test cases
...
public void setup()
{
   ...
   circle2 = new Circle1(7,7,8);
   circle3 = new Circle1(0,0,1);
   circle4 = new Circle1(0,2,1);
}
...
public void intersect()
{
   ...
   Assert.assertTrue(circle1.intersects(circle2)==true); //circles should intersect
}
...
public void intersect2()
{
   ...
   Assert.assertTrue(circle3.intersects(circle4)==true); //circles should intersect
}
